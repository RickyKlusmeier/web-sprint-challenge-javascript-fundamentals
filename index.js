...
/* The nested function can access the variable internal since internal is not found inside of its own nestedFunction scope, it continues to go up the tree to find where the variable internal is until it finds it. */
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(arr){
    let lowerCaseNames = arr.map((item) => item.animal_name.toLowerCase());
  ...
  */
  ...
  function lowPopulationAnimals(arr){
    let lowPopulationAnimals = arr.filter((item) => item.population < 5);
  ...
  */
  ...
  function USApop(arr){
    let usPop = arr.reduce(function(accumulator, item){
